...
```
**Important**: Always save screenshots to a valid directory in your project.
...
Example:
```bash
node screenshot.js --url https://example.com --output /path/to/project/docs/screenshots/page.png
ls -lh /path/to/project/docs/screenshots/page.png  # Verify file exists
